...
{
    int i = 0;
    //int x1 = *(bombLocatX), y1 = *(bombLocatY), x2 = *(bombLocatX + 1), x2 = bombLocatY + 1;
    ...
    while (i < 8) {
        ...
        //printf("bomb chossen: %i and %i, randSwap %i\n", a, b, randSwap);
        //showSwap(gRenderer, gTextureBox, gTextureGalaxy, table, n, a, b, randSwap);
